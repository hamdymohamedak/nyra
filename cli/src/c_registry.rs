...
const BUILTIN: &[(&str, &str)] = &[
    ...
    ("arrow", include_str!("../../registry/c/arrow.toml")),
    ("assimp", include_str!("../../registry/c/assimp.toml")),
    ("aws-c-common", include_str!("../../registry/c/aws-c-common.toml")),
    ("aws-c-s3", include_str!("../../registry/c/aws-c-s3.toml")),
    ("aws-sdk-cpp", include_str!("../../registry/c/aws-sdk-cpp.toml")),
    ("azure-iot-sdk-c", include_str!("../../registry/c/azure-iot-sdk-c.toml")),
    ...
    ("ctranslate2", include_str!("../../registry/c/ctranslate2.toml")),
    ...
    ("cyrus-sasl", include_str!("../../registry/c/cyrus-sasl.toml")),
    ...
    ("duckdb", include_str!("../../registry/c/duckdb.toml")),
    ("duktape", include_str!("../../registry/c/duktape.toml")),
    ("eigen", include_str!("../../registry/c/eigen.toml")),
    ("elasticsearch-c", include_str!("../../registry/c/elasticsearch-c.toml")),
    ...
    ("grpc", include_str!("../../registry/c/grpc.toml")),
    ("grpcpp", include_str!("../../registry/c/grpcpp.toml")),
    ("gsl", include_str!("../../registry/c/gsl.toml")),
    ("gst-plugins-base", include_str!("../../registry/c/gst-plugins-base.toml")),
    ("gstreamer", include_str!("../../registry/c/gstreamer.toml")),
    ...
    ("krb5", include_str!("../../registry/c/krb5.toml")),
    ...
    ("libwebrtc", include_str!("../../registry/c/libwebrtc.toml")),
    ...
    ("mkl", include_str!("../../registry/c/mkl.toml")),
    ("moltenvk", include_str!("../../registry/c/moltenvk.toml")),
    ...
    ("nanoarrow", include_str!("../../registry/c/nanoarrow.toml")),
    ("nats-c", include_str!("../../registry/c/nats-c.toml")),
    ("nccl", include_str!("../../registry/c/nccl.toml")),
    ("ncurses", include_str!("../../registry/c/ncurses.toml")),
    ("neo4j-client", include_str!("../../registry/c/neo4j-client.toml")),
    ...
    ("onedal", include_str!("../../registry/c/onedal.toml")),
    ...
    ("openldap", include_str!("../../registry/c/openldap.toml")),
    ("openssl", include_str!("../../registry/c/openssl.toml")),
    ("opentelemetry-c", include_str!("../../registry/c/opentelemetry-c.toml")),
    ("opentelemetry-cpp", include_str!("../../registry/c/opentelemetry-cpp.toml")),
    ...
    ("pam", include_str!("../../registry/c/pam.toml")),
    ("pango", include_str!("../../registry/c/pango.toml")),
    ("parquet", include_str!("../../registry/c/parquet.toml")),
    ("pcl", include_str!("../../registry/c/pcl.toml")),
    ("pcre2", include_str!("../../registry/c/pcre2.toml")),
    ("pdfium", include_str!("../../registry/c/pdfium.toml")),
    ("physfs", include_str!("../../registry/c/physfs.toml")),
    ("pkcs11-helper", include_str!("../../registry/c/pkcs11-helper.toml")),
    ...
    ("thrift", include_str!("../../registry/c/thrift.toml")),
    ...
    ("tpm2-tss", include_str!("../../registry/c/tpm2-tss.toml")),
    ...
    ("wamr", include_str!("../../registry/c/wamr.toml")),
    ("wasmer", include_str!("../../registry/c/wasmer.toml")),
    ("wasmtime", include_str!("../../registry/c/wasmtime.toml")),
    ("wayland", include_str!("../../registry/c/wayland.toml")),
    ("whisper-cpp", include_str!("../../registry/c/whisper-cpp.toml")),
    ("wireguard", include_str!("../../registry/c/wireguard.toml")),
    ...
    ("zbar", include_str!("../../registry/c/zbar.toml")),
    ...
    ("zxing-cpp", include_str!("../../registry/c/zxing-cpp.toml")),
