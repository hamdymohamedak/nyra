...
fn copy_game(x, y, hp, score, turn, status){
    return GameState {
        x: x,
        y: y,
        hp: hp,
...
fn apply_tile_at(sx, sy, shp, sscore, sturn, sstatus, tile){
    return match tile {
...
fn advance_parts(sx, sy, shp, sscore, sturn, sstatus, dx, dy){
