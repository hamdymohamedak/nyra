...
// Regenerate: nyra bind c /opt/homebrew/include/raylib.h \
...
extern fn SetGamepadVibration(gamepad: i32, leftMotor: f32, rightMotor: f32, duration: f32) -> void
...
extern fn UpdateCameraPro(camera: ptr, movement: Vector3, rotation: Vector3, zoom: f32) -> void
...
extern fn DrawCircleGradient(centerX: i32, centerY: i32, radius: f32, inner: Color, outer: Color) -> void
...
extern fn DrawRectangleRoundedLines(rec: Rectangle, roundness: f32, segments: i32, color: Color) -> void
extern fn DrawRectangleRoundedLinesEx(rec: Rectangle, roundness: f32, segments: i32, lineThick: f32, color: Color) -> void
...
extern fn DrawSplineLinear(points: ptr, pointCount: i32, thick: f32, color: Color) -> void
extern fn DrawSplineBasis(points: ptr, pointCount: i32, thick: f32, color: Color) -> void
extern fn DrawSplineCatmullRom(points: ptr, pointCount: i32, thick: f32, color: Color) -> void
extern fn DrawSplineBezierQuadratic(points: ptr, pointCount: i32, thick: f32, color: Color) -> void
extern fn DrawSplineBezierCubic(points: ptr, pointCount: i32, thick: f32, color: Color) -> void
...
extern fn GenImageGradientSquare(width: i32, height: i32, density: f32, inner: Color, outer: Color) -> Image
...
extern fn GenImagePerlinNoise(width: i32, height: i32, offsetX: i32, offsetY: i32, scale: f32) -> Image
...
extern fn ImageTextEx(font: Font, text: string, fontSize: f32, spacing: f32, tint: Color) -> Image
...
extern fn ImageAlphaCrop(image: ptr, threshold: f32) -> void
extern fn ImageAlphaClear(image: ptr, color: Color, threshold: f32) -> void
...
extern fn ImageColorContrast(image: ptr, contrast: f32) -> void
...
extern fn ImageDrawTextEx(dst: ptr, font: Font, text: string, position: Vector2, fontSize: f32, spacing: f32, tint: Color) -> void
...
extern fn DrawTextureNPatch(texture: Texture, nPatchInfo: NPatchInfo, dest: Rectangle, origin: Vector2, rotation: f32, tint: Color) -> void
...
extern fn DrawTextEx(font: Font, text: string, position: Vector2, fontSize: f32, spacing: f32, tint: Color) -> void
extern fn DrawTextPro(font: Font, text: string, position: Vector2, origin: Vector2, rotation: f32, fontSize: f32, spacing: f32, tint: Color) -> void
extern fn DrawTextCodepoint(font: Font, codepoint: i32, position: Vector2, fontSize: f32, tint: Color) -> void
extern fn DrawTextCodepoints(font: Font, codepoints: ptr, codepointCount: i32, position: Vector2, fontSize: f32, spacing: f32, tint: Color) -> void
extern fn SetTextLineSpacing(spacing: i32) -> void
extern fn MeasureText(text: string, fontSize: i32) -> i32
extern fn MeasureTextEx(font: Font, text: string, fontSize: f32, spacing: f32) -> Vector2
...
extern fn TextToFloat(text: string) -> f32
...
extern fn DrawCapsule(startPos: Vector3, endPos: Vector3, radius: f32, slices: i32, rings: i32, color: Color) -> void
extern fn DrawCapsuleWires(startPos: Vector3, endPos: Vector3, radius: f32, slices: i32, rings: i32, color: Color) -> void
...
extern fn DrawBillboard(camera: Camera3D, texture: Texture, position: Vector3, scale: f32, tint: Color) -> void
...
extern fn DrawBillboardPro(camera: Camera3D, texture: Texture, source: Rectangle, position: Vector3, up: Vector3, size: Vector2, origin: Vector2, rotation: f32, tint: Color) -> void
